...
* The native build tools is not configured with the Kotlin DSL,
  check [the documentation](https://docs.spring.io/spring-native/docs/0.11.2/reference/htmlsingle/#_add_the_native_build_tools_plugin)
  for more details.
...
```
$ docker run --rm -p 8080:8080 api-de-estudo:0.0.1-SNAPSHOT
```
...
```
$ build/native-image/api-de-estudo
```
